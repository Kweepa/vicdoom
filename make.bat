...
c:\app\vice\c1541 -format doom,id d64 doom.d64 -write doom.prg -write textures -write e1m1 -write e1m2 -write e1m3 -write e1m4 -write e1m5 -write e1m1mus -write sluts -write sounds -write lowcode -write keys.pt -write keys.co -write cred.pt -write cred.co -write buy.pt -write buy.co
