...
c:\app\WinVice-2.1\WinVice-2.1\c1541 -format doom,id d64 doom.d64 -write doom.prg -write textures -write e1m1 -write e1m2 -write e1m1mus -write sluts -write sounds -write lowcode -write keys -write cred
